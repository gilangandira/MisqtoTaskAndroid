...
class AddTask extends StatefulWidget {
  final Assets assets;
  const AddTask({super.key, required this.assets});
  ...
  Future<void> addTask() async {
    try {
      ...
      final response = await dio.post(
        "https://misqot.repit.tech/api/task/store",
        data: {
          'name': _name.text,
          'assets_id': widget.assets.id.toString(),
                ...
                child: Container(
                  ...
                  child: ListView(
                    children: [
                      ...
                      //   child: DropdownButtonFormField<SLA>(
                      //     value: selectedTime,
                      //     onChanged: (SLA? newValue) {
                      //       setState(() {
                      //         selectedTime = newValue;
                      //       });
                      //     },
                      //     items: timeList.map((SLA sla) {
                      //       return DropdownMenuItem<SLA>(
                      //         value: sla,
                      //         child: Text(sla.name),
                      //       );
                      //     }).toList(),
                      //     decoration: const InputDecoration(labelText: "SLA",prefixIcon: Icon(Icons.email),enabledBorder: OutlineInputBorder(borderSide: BorderSide(width:2,color: Colors.blue),),),
                      //   ),
                      // ),
                      Container(
                          margin: const EdgeInsets.only(left: 20,top: 20),
                          child: const Text("Workmanship",style: TextStyle(color: Colors.blue,fontSize: 20,),)),
                      Container(
                        height: 100,
                        padding: const EdgeInsets.all(20),
                                ...
                                child: Container(
                                  padding: const EdgeInsets.all(10),
                                    ...
                                    decoration: BoxDecoration(
                                      color: selectedTime == timeList[index] ? Colors.blue : Colors.grey,
                      ...
                      // Container(
                      //   child: ListView.builder(
                      //     itemCount: listUserController.length,
                      //     itemBuilder: (context, index) {
                      //       return Container(
                      //         padding: const EdgeInsets.all(20),
                      ...
                      //             );
                      //           }).toList(),
                      //           decoration: const InputDecoration(labelText: "User",prefixIcon: Icon(Icons.email),enabledBorder: OutlineInputBorder(borderSide: BorderSide(width:2,color: Colors.blue),),),
                      //         ),
                      //       );
                      //     },
                      //
                      ...
                      GestureDetector(
                        ...
                        child: GestureDetector(
                            onTap: () async {
                              if (_formKey.currentState!.validate()) {
                              await addTask(); // Tunggu hingga permintaan selesai
